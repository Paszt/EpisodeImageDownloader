...
Namespace ViewModels
    ...
    Public Class TheNightlyShowViewModel
...
#End Region
        ...
        Private Function DownloadFolder() As String
            If SeasonNumber.HasValue Then
                Return IO.Path.Combine(My.Settings.DownloadFolder, "The Nightly Show", "Season " & SeasonNumber.Value.ToString("00"))
            Else
                Return String.Empty
            End If
        End Function
        ...
        Private Function GetImageUrl(seasonNumber As Integer, episodeNumber As Integer, imageSuffix As String) As String
            ...
            Dim format As String = "http://3.images.comedycentral.com/images/shows/nightly_show/videos/season_{0}/{1}{2}/ns_{1}_{2}{3}.jpg?quality=0.85"
        ...
        Private Function GetLocalNotFoundFileName(seasonNumber As Integer, episodeNumber As Integer) As String
            Dim format As String = "ns_{0}_{1}_XNotFound.jpg"
